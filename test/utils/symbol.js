...
describe('Utils => Symbol', () => {
  it('ADD', () => {
    expect(symbol.ADD(utils.blank, utils.blank)).to.equal(0)
  ...
  it('DIVIDE', () => {
    expect(symbol.DIVIDE(utils.blank, 2)).to.equal(0)
    expect(symbol.DIVIDE(2, utils.blank)).to.equal(error.div0)
  ...
  it('EQ', () => {
    ...
    expect(symbol.EQ(utils.blank, utils.blank)).to.equal(true)
    expect(symbol.EQ(utils.blank, null)).to.equal(true)
    expect(symbol.EQ(utils.blank, undefined)).to.equal(true)
  ...
  it('GT', () => {
    ...
    expect(symbol.GT(undefined, utils.blank)).to.equal(false)
    ...
    expect(symbol.GT(utils.blank, 4)).to.equal(false)
    expect(symbol.GT(4, utils.blank)).to.equal(true)
  ...
  it('GTE', () => {
    ...
    expect(symbol.GTE(undefined, utils.blank)).to.equal(true)
    expect(symbol.GTE(1, undefined)).to.equal(true)
    expect(symbol.GTE(1, utils.blank)).to.equal(true)
    expect(symbol.GTE(utils.blank, 1)).to.equal(false)
  ...
  it('LT', () => {
    ...
    expect(symbol.LT(undefined, utils.blank)).to.equal(false)
    expect(symbol.LT(1, undefined)).to.equal(false)
    expect(symbol.LT(1, utils.blank)).to.equal(false)
    expect(symbol.LT(utils.blank, 1)).to.equal(true)
  ...
  it('LTE', () => {
    ...
    expect(symbol.LTE(undefined, utils.blank)).to.equal(true)
    expect(symbol.LTE(1, undefined)).to.equal(false)
    expect(symbol.LTE(1, utils.blank)).to.equal(false)
    expect(symbol.LTE(utils.blank, 1)).to.equal(true)
  ...
  it('MINUS', () => {
    ...
    expect(symbol.MINUS(utils.blank, utils.blank)).to.equal(0)
    expect(symbol.MINUS(1, utils.blank)).to.equal(1)
  ...
  it('MULTIPLY', () => {
    ...
    expect(symbol.MULTIPLY(utils.blank, utils.blank)).to.equal(0)
    expect(symbol.MULTIPLY(1, utils.blank)).to.equal(0)
  ...
  it('NE', () => {
    ...
    expect(symbol.NE(undefined, utils.blank)).to.equal(false)
    expect(symbol.NE(utils.blank, utils.blank)).to.equal(false)
    ...
    expect(symbol.NE(1, utils.blank)).to.equal(true)
  ...
  it('POW', () => {
    ...
    expect(symbol.POW(utils.blank, utils.blank)).to.equal(error.num)
    expect(symbol.POW(undefined, 2)).to.equal(0)
    expect(symbol.POW(utils.blank, 2)).to.equal(0)
    expect(symbol.POW(5, undefined)).to.equal(1)
    expect(symbol.POW(5, utils.blank)).to.equal(1)
